...
function Cart({ cart, onClose, onAdd, onRemove, onDeleteAll }: CartProps) {
      ...
      <div className="cart-panel" onClick={(e) => e.stopPropagation()}>
        ...
        {cart.length === 0 ? (
          ...
          <div className="empty-cart">
            ...
            <p>Agrega tus bebidas favoritas para comenzar tu pedido</p>
            <button
              className="empty-btn"
            ...
            <div className="cart-footer">
              ...
              {!user && (
                <div className="mini-login-card">
                  ...
                  <p>Inicia sesión o regístrate para guardar tu historial de compras.</p>
